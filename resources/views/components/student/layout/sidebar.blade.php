...
<div id="sidebar" class="sidebar">
    <div class="flex flex-col items-center px-6 py-6 border-b border-white border-opacity-20">
        ...
        <div class="text-center">
            ...
            <p class="text-xs opacity-80 mt-1">Learning Management System</p>
        </div>
    </div>
    
    <nav class="flex-1 px-3 py-6 space-y-2" aria-label="Main Navigation">
        <a href="{{ route('student.dashboard') }}" class="flex items-center px-4 py-3 text-white sidebar-item {{ $activeItem === 'dashboard' ? 'active' : '' }}">
        ...
        <a href="{{ route('student.courses') }}" class="flex items-center px-4 py-3 text-white sidebar-item {{ $activeItem === 'courses' ? 'active' : '' }}">
            <div class="sidebar-icon bg-white bg-opacity-20 w-10 h-10 rounded-xl flex items-center justify-center">
        ...
        <a href="{{ route('student.catalog') }}" class="flex items-center px-4 py-3 text-white sidebar-item {{ $activeItem === 'catalog' ? 'active' : '' }}">
            <div class="sidebar-icon bg-white bg-opacity-20 w-10 h-10 rounded-xl flex items-center justify-center">
        ...
        <a href="{{ route('student.resources') }}" class="flex items-center px-4 py-3 text-white sidebar-item {{ $activeItem === 'resources' ? 'active' : '' }}">
            <div class="sidebar-icon bg-white bg-opacity-20 w-10 h-10 rounded-xl flex items-center justify-center">
