<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <?= component('dashboard/page-header', ['management_type' => 'student', 'route' => '/admin/student/create', 'headerIcon' => 'user', 'hasAdd' => true]) ?>
    </div>
    <div class="row mb-4">
...
<script>
    ...
    $(document).ready(() => {
        ...
        const columns = [
            ...
            {
                data: null,
                render: () => '<span class="badge badge-primary px-3 py-2">1</span><br><small class="text-muted">Courses Enrolleds</small>',
            },
        ];
